#include <jni.h>
#include <stdio.h>
#include "com_fi_uba_ar_services_detectors_NativeHandTrackingDetector.hpp"
...
JNIEXPORT jintArray JNICALL Java_com_fi_uba_ar_services_detectors_NativeHandTrackingDetector_detect(
...
JNIEXPORT jboolean JNICALL Java_com_fi_uba_ar_services_detectors_NativeHandTrackingDetector_init(JNIEnv *env, jobject thiz) {
	init();
	return true;
}

JNIEXPORT void JNICALL Java_com_fi_uba_ar_services_detectors_NativeHandTrackingDetector_sampleHandColor(JNIEnv *env, jobject thiz, jlong matAddr) {
	Mat& image = *(Mat*) matAddr;
